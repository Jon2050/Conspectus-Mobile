Task: Implement issue `M4-03` end-to-end with full verification.
...
1. Load context from:
   ...
   - `docs/GitHub-Issues-MVP-Backlog.md`
     Then locate `M4-03` and extract implementation steps, acceptance criteria, and dependencies/constraints.
